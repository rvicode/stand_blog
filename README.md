...
This is a blog project and boilerplate to start a django project with postgresql as database running on docker.
...
```bash
git clone https://github.com/rvicode/stand_blog.git
```
